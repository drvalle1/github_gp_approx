...
credit.full<-read.csv("creditbank.csv", header = TRUE, sep = ";")
#Treat data
credit.full$SEX<-credit.full$SEX-1
credit<-credit.full

#Rename Y variable
colnames(credit)[24]<-"microsc1"
colnames(credit.full)[24]<-"microsc1"
#Create intercept
credit$interc<-1
...
y.train<- credit.full$microsc1[ids]
credit.valid<-credit[-ids,]
y.valid<- credit.full$microsc1[-ids]
